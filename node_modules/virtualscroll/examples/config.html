...
<body>
    <h3>默认配置项</h3>
    <h5> JS引用：vsobj.$Options</h5>
    <div style="border-left:1px solid #ccc;margin:30px 0 0 0;font-size:18px;width:100%;">
    <pre>
    let boxa = document.querySelector('.boxa');
    let vsobj = VirtualScroll(boxa, {
        ...
        WheelStep: 80, // 默认每次滚动 80px, 滚轮滚动时单步滑动的距离（快慢） 单位是 px (也包括鼠标点击滚动条时的单步滑动距离)
