...
<body>
    <h3>dragging 鼠标拖动进行中</h3><i>打开控制台查看结果</i>
    <div class="boxa">
    ...
    <div style="border-left:6px solid #ccc;padding:12px;margin:12px 0 12px 0;">
        <p>dragging 的 this 指向根元素 实例obj</p>
        <p>作用：拖动滑块时连续触发</p>
        <p>orientation: 表示滚动方向，水平滚动会输出 "left" 或 "right"，垂直滚动会输出 "top" 或 "bottom"</p>
        <p>position：滚动条在滚动行进中，滑块行程的百分比 0 - 1</p>
    </div>
