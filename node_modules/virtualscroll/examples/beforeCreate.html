...
<body>
    ...
    <div style="border-left:6px solid #ccc;padding:12px;margin:12px 0 12px 0;">
        <p>beforeCreate 的 this 指向根元素 boxa</p>
        <p>作用：在滚动条渲染之前，对根元素里的内容进行编辑修改等操作</p>
        <p>不要在这个钩子里执行异步操作，暂时不支持异步</p>
        <p>如果想 ajax 方式获取数据，请在 ajax 的回调里执行 VirtualScroll 渲染</p>
    </div>
