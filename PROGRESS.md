...
- Hover: film plays, card flattens (`blendFactor → 2`), and **the pose** — the card rises, comes
  forward 5 units along the camera's view ray (≈1.15× on screen), slerps round to face the viewer
  square-on, and is **composited in front of the whole deck** (`applyHoverPose`, AUDIT
  #125/#128/#130/#131; desktop only, a phone keeps the lift alone) — centre text swaps; single
  card only
