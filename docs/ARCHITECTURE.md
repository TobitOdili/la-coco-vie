...
| **Seven dead links** | Everything a guest can click that goes nowhere: **RSVP** (`SITE.nav.collectionUrl`, in the nav *and* every chapter end — the primary CTA), With Love's **cash card**, In Frames' **"Add Your Photos"** Drive folder, **both maps**, **Add to Calendar** (needs a real `.ics`), and the bottom-left **credit** link. (An earlier version of this row said "three" — it undercounted the Big Day popups.) |
